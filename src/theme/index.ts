...
const theme = (dark = false) => ({
	...
	buttonGradient: {
		...
		hover: 'linear-gradient(225deg, #242436, #1b1b29) padding-box, linear-gradient(157.5deg, #5455c9, #53c7e4) border-box',
	},
	heroGradient: 'linear-gradient(to left, #6b9aef 0%, #65c48c 33%, #1fa6e0 66%, #6b9aef 100%)',
	topBarSize: 72,
	backgroundGradient: dark
		? {
				default: 'radial-gradient(circle at center, #391818, #210e0e 50%) fixed',
		  }
		: {
				default: 'radial-gradient(circle at center, #efeae7, #fff8ee 50%) fixed',
		  },
