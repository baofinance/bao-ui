...
export interface BalancerComposableStablePoolInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "getTokenRate(address)",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getTokenRateCache(address)",
    values: [PromiseOrValue<string>]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setAssetManagerPoolConfig(address,bytes)",
    values: [PromiseOrValue<string>, PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
  ...
  getEvent(
    nameOrSignatureOrTopic: "ProtocolFeePercentageCacheUpdated(uint256,uint256)"
  ): EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "TokenRateCacheUpdated(uint256,uint256)"
  ): EventFragment;
  getEvent(nameOrSignatureOrTopic: "TokenRateProviderSet"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "TokenRateProviderSet(uint256,address,uint256)"
  ): EventFragment;
...
export interface BalancerComposableStablePool extends BaseContract {
  contractName: "BalancerComposableStablePool";
