...
export interface UniPoolInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "earned(address)",
    values: [PromiseOrValue<string>]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "notifyRewardAmount(uint256)",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setRewardDistribution(address)",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "userRewardPerTokenPaid(address)",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  getEvent(
    nameOrSignatureOrTopic: "ReferralReward(address,address,uint256)"
  ): EventFragment;
  getEvent(nameOrSignatureOrTopic: "ReferralSet"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "ReferralSet(address,address)"
  ): EventFragment;
  getEvent(nameOrSignatureOrTopic: "RewardAdded"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "RewardAdded(uint256)"): EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "Withdrawn(address,uint256)"): EventFragment;
}
...
export type ReferralSetEvent = TypedEvent<
  [string, string],
  ReferralSetEventObject
>;
