...
export interface MinterInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "mint_many(address[8])",
    values: [PromiseOrValue<string>[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "mint_for(address,address)",
    values: [PromiseOrValue<string>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "toggle_approve_mint(address)",
    values: [PromiseOrValue<string>]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "minted(address,address)",
    values: [PromiseOrValue<string>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "allowed_to_mint_for(address,address)",
    values: [PromiseOrValue<string>, PromiseOrValue<string>]
  ): string;
