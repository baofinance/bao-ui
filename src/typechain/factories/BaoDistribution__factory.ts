...
import type {
  BaoDistribution,
  BaoDistributionInterface,
} from "../BaoDistribution";
...
export class BaoDistribution__factory {
  static readonly abi = _abi;
  static createInterface(): BaoDistributionInterface {
    return new utils.Interface(_abi) as BaoDistributionInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BaoDistribution {
    return new Contract(address, _abi, signerOrProvider) as BaoDistribution;
  }
}
