...
import type { Experipie, ExperipieInterface } from "../Experipie";
...
export class Experipie__factory {
  static readonly abi = _abi;
  static createInterface(): ExperipieInterface {
    return new utils.Interface(_abi) as ExperipieInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): Experipie {
    return new Contract(address, _abi, signerOrProvider) as Experipie;
  }
}
