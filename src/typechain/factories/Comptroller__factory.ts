...
const _abi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "oldimfFactorMantissa",
        type: "uint256",
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "newimfFactorMantissa",
        type: "uint256",
      },
    ],
    name: "NewImfFactor",
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        internalType: "bool[]",
        name: "borrowRestrictions",
        type: "bool[]",
      },
    ],
    name: "_setBorrowRestriction",
    outputs: [],
    payable: false,
    stateMutability: "nonpayable",
    type: "function",
