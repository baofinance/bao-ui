...
import type { Lens, LensInterface } from "../Lens";
...
export class Lens__factory {
  static readonly abi = _abi;
  static createInterface(): LensInterface {
    return new utils.Interface(_abi) as LensInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): Lens {
    return new Contract(address, _abi, signerOrProvider) as Lens;
  }
}
