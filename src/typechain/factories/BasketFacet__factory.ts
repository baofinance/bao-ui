...
import type { BasketFacet, BasketFacetInterface } from "../BasketFacet";
...
const _abi = [
  ...
  },
  {
    ...
    name: "EntryFeeBeneficiaryShareSet",
    type: "event",
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    name: "ExitFeeBeneficiaryShareSet",
    type: "event",
  },
  {
    anonymous: false,
...
export class BasketFacet__factory {
  static readonly abi = _abi;
  static createInterface(): BasketFacetInterface {
    return new utils.Interface(_abi) as BasketFacetInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BasketFacet {
    return new Contract(address, _abi, signerOrProvider) as BasketFacet;
  }
}
