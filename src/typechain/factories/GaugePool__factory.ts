...
import type { GaugePool, GaugePoolInterface } from "../GaugePool";
...
export class GaugePool__factory {
  static readonly abi = _abi;
  static createInterface(): GaugePoolInterface {
    return new utils.Interface(_abi) as GaugePoolInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): GaugePool {
    return new Contract(address, _abi, signerOrProvider) as GaugePool;
  }
}
