...
import type { GaugeDeposit, GaugeDepositInterface } from "../GaugeDeposit";
...
export class GaugeDeposit__factory {
  static readonly abi = _abi;
  static createInterface(): GaugeDepositInterface {
    return new utils.Interface(_abi) as GaugeDepositInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): GaugeDeposit {
    return new Contract(address, _abi, signerOrProvider) as GaugeDeposit;
  }
}
