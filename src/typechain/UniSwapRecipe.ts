...
export interface UniSwapRecipeInterface extends utils.Interface {
  functions: {
...
export interface UniSwapRecipe extends BaseContract {
  contractName: "UniSwapRecipe";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UniSwapRecipeInterface;
