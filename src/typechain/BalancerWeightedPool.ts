...
export interface BalancerWeightedPoolInterface extends utils.Interface {
  functions: {
...
export interface BalancerWeightedPool extends BaseContract {
  contractName: "BalancerWeightedPool";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BalancerWeightedPoolInterface;
  ...
  functions: {
    ...
    getATHRateProduct(overrides?: CallOverrides): Promise<[BigNumber]>;
