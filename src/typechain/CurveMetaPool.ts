...
export interface CurveMetaPoolInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | "initialize"
      | "initialize(string,string,address,uint256,uint256,uint256)"
      | "decimals"
      | "decimals()"
      | "transfer"
  ...
  encodeFunctionData(
    functionFragment: "initialize(string,string,address,uint256,uint256,uint256)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<string>,
  ...
  encodeFunctionData(
    functionFragment: "ramp_A(uint256,uint256)",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "admin_balances(uint256)",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  getEvent(
    nameOrSignatureOrTopic: "TokenExchange(address,int128,uint256,int128,uint256)"
  ): EventFragment;
  getEvent(nameOrSignatureOrTopic: "TokenExchangeUnderlying"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "TokenExchangeUnderlying(address,int128,uint256,int128,uint256)"
  ): EventFragment;
  getEvent(nameOrSignatureOrTopic: "AddLiquidity"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "AddLiquidity(address,uint256[2],uint256[2],uint256,uint256)"
  ): EventFragment;
  getEvent(nameOrSignatureOrTopic: "RemoveLiquidity"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "RemoveLiquidity(address,uint256[2],uint256[2],uint256)"
  ): EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "RemoveLiquidityImbalance(address,uint256[2],uint256[2],uint256,uint256)"
  ): EventFragment;
...
export interface CurveMetaPool extends BaseContract {
  ...
  functions: {
    initialize(
      ...
      _rate_multiplier: PromiseOrValue<BigNumberish>,
