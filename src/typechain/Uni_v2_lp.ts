...
export interface Uni_v2_lpInterface extends utils.Interface {
  functions: {
...
export interface Uni_v2_lp extends BaseContract {
  contractName: "Uni_v2_lp";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Uni_v2_lpInterface;
