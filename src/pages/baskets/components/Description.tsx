...
const BDEFI: React.FC = () => (
	<>
		...
		<Typography variant='h3'>Characteristics</Typography>
		<BasketList>
		...
		<Typography>The Basket is maintained quarterly in two phases.</Typography>
		<Typography>
			<Typography variant='h3'>Determination Phase</Typography>
		</Typography>
		<Typography>
		...
		<Typography>
			<Typography variant='h3'>Reconstitution Phase</Typography>
		</Typography>
		<Typography>
...
const BSTBL: React.FC = () => (
	<>
		...
		<Typography variant='xl'>Fees</Typography>
		<ul>
			<li>Entry Fee: 0%</li>
		...
		<Typography variant='xl'>Characteristics</Typography>
		<ul>
