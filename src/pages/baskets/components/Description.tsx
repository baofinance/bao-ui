...
const BDEFI: React.FC = () => (
	<>
		...
		<Typography variant='paragraph'>The Basket is maintained quarterly in two phases.</Typography>
		<Typography variant='h5'>Determination Phase</Typography>
		<Typography variant='paragraph'>
		...
		<Typography variant='h5'>Reconstitution Phase</Typography>
		<Typography variant='paragraph'>
...
const BSTBL: React.FC = () => (
	<>
		...
		<Typography variant='h5'>Emergency Maintenance</Typography>
		<Typography variant='paragraph'>
