...
import { NestBoxHeader, NestExplanation, NestHeader, NestList, NestSubHeader } from '../styles'
...
const nSTBL: React.FC = () => (
	<>
			...
			<p>
				...
				and have yield strategies that are suitable for a stables nest on
				polygon.
			</p>
			...
			<p>
				In the two weeks following a successful vote, the nest components will
			...
			<p>
				...
				in the event of a protocol or nest being in danger of failing.
			</p>
			<p>
